...
class PieceSelectorManager
{
    ...
    isMoveSelected(x, y, piece)
    {
        ...
        for (let m = 0; m < piece._moves.length; m++)
        {
            if (this.inCase(x, y, piece._moves[m].l, piece._moves[m].c))
            {
                console.log("good move");
                this.moveSelected = {l:piece._moves[m].l, c:piece._moves[m].c};
                this._isMoveSelected = true;
                return true;
            }   
        }
